...
- [x] 自动专题中心：`/topics` 与 `/topic/:name`
- [x] 球队 / 球员实体索引：`/entities` 与 `/entity/:name`
- [x] 转会中心：`/transfers`
- [x] 伤停中心：`/injuries`
- [x] 新闻趋势：`/trends`，基于每日快照生成类别趋势
- [x] 新闻关系图：`/relations`，基于球队 / 球员 / 赛事标签共现
- [x] 每日智能简报：`/brief`
- [x] 配置 AI 时生成缓存式中文摘要；无 AI 时自动使用规则摘要
- [x] “只看我的关注”本地个性化新闻流
- [x] 新闻故事页增加 Schema.org `NewsArticle` 结构化数据
- [x] 首页搜索同时覆盖事件键与 AI 标签


## V58 深度门户增强

- [x] 24 小时 / 7 天热点榜：`/hot?hours=24|168`
- [x] 五大联赛独立入口：`/leagues`
- [x] 联赛详情页：`/league/:id`
- [x] 比赛详情页：`/match/:key`
- [x] 比赛页自动关联相关新闻
- [x] 故事页相关新闻推荐
- [x] 可点击 SVG 足球实体关系网络
- [x] 修复“只看我的关注”仅处理首条新闻的问题
- [x] 修复比赛详情路由键解码问题
- [x] PWA Service Worker 覆盖新增动态页面
