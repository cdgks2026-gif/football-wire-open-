...
self.addEventListener("fetch",e=>{
  ...
  if(u.pathname.startsWith("/api/")||u.pathname.startsWith("/story/")||u.pathname.startsWith("/search")||u.pathname.startsWith("/archive")||u.pathname.startsWith("/matches")){
